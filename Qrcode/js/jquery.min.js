...
(function (a, b) {
    ...
    function bN(a, c, d, e, f, g) {
        ...
        typeof l === "string" && (!k || g[l] ? l = b : (c.dataTypes.unshift(l), l = bN(a, c, d, e, l, g))); (k || !l) && !g["*"] && (l = bN(a, c, d, e, "*", g));
        return l
    }
    function bM(a) {
        return function (b, c) {
            ...
            for (j = 0, k = f.length; j < k; j++) {
                ...
                for (i = 0; i < t.length; i++) {
                    ...
                    if (m.selector === g.selector && (!n || n.test(g.namespace)) && !m.elem.disabled) {
                        ...
                        e = d(a.relatedTarget).closest(g.selector)[0]; (!e || e !== h) && q.push({
                            elem: h,
                            handleObj: g,
                            level: m.level
                        })
    ...
    d.fn.extend({
            ...
            if (a && typeof a === "string") {
                ...
                e = this.length; c < e; c++) {
                    ...
                    if (f.nodeType === 1) if (f.className) {
                        ...
                        h = f.className;
                        for (var j = 0,
                        k = b.length; j < k; j++) g.indexOf(" " + b[j] + " ") < 0 && (h += " " + b[j]);
            ...
            if (a && typeof a === "string" || a === b) {
                ...
                f = this.length; e < f; e++) {
                    ...
                    if (g.nodeType === 1 && g.className) if (a) {
                        ...
                        for (var k = 0,
                        l = c.length; k < l; k++) j = j.replace(" " + c[k] + " ", " ");
        ...
        hasClass: function (a) {
            var b = " " + a + " ";
            for (var c = 0,
            d = this.length; c < d; c++) if ((" " + this[c].className + " ").replace(h, " ").indexOf(b) > -1) return !0;
            return !1
        },
        val: function (a) {
            if (!arguments.length) {
    ...
    d.support.submitBubbles || (d.event.special.submit = {
        setup: function (a, b) {
            ...
            function (a) {
                var b = a.target,
                c = b.type; (c === "submit" || c === "image") && d(b).closest("form").length && C("submit", this, arguments)
            }),
            d.event.add(this, "keypress.specialSubmit",
            function (a) {
                var b = a.target,
                c = b.type; (c === "text" || c === "password") && d(b).closest("form").length && a.keyCode === 13 && C("submit", this, arguments)
            });
            else return !1
        },
        teardown: function (a) {
    ...
    if (!d.support.changeBubbles) {
        ...
        d.event.special.change = {
            filters: {
                ...
                click: function (a) {
                    var b = a.target,
                    c = b.type; (c === "radio" || c === "checkbox" || b.nodeName.toLowerCase() === "select") && B.call(this, a)
                },
                keydown: function (a) {
                    var b = a.target,
                    c = b.type; (a.keyCode === 13 && b.nodeName.toLowerCase() !== "textarea" || a.keyCode === 32 && (c === "checkbox" || c === "radio") || c === "select-multiple") && B.call(this, a)
                },
    ...
    function (a, c) {
        d.fn[c] = function (a, e, f, g) {
            ...
            while ((h = a[i++]) != null) {
                ...
                if (c === "live") for (var q = 0,
                r = n.length; q < r; q++) d.event.add(n[q], "live." + F(h, m), {
                    data: e,
                    selector: m,
                    handler: f,
                    origType: h,
        ...
        domManip: function (a, c, e) {
            ...
            if (this[0]) {
                ...
                if (g) {
                    ...
                    for (var l = 0,
                    m = this.length,
                    n = m - 1; l < m; l++) e.call(c ? Y(this[l], g) : this[l], f.cacheable || m > 1 && l < n ? d.clone(h, !0, !0) : h)
                }
